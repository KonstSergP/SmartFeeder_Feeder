...
@pytest.fixture
def mock_settings():
    with patch('server_connection.settings') as mock_settings:
        mock_settings.online_mode = True
        yield mock_settings


class TestServerConnection:

    def test_init_online_mode(self, mock_socketio, mock_log, mock_get_feeder_id, mock_thread, mock_settings):
    ...
    def test_init_offline_mode(self, mock_socketio, mock_log, mock_get_feeder_id, mock_thread, mock_settings):
        mock_settings.online_mode = False
    ...
    def test_connect_to_server_with_id(self, mock_socketio, mock_get_feeder_id, mock_get_socket_address, mock_settings):
        mock_settings.client_type = "feeder"
        server_conn = ServerConnection()
    ...
    def test_connect_to_server_without_id(self, mock_socketio, mock_get_socket_address, mock_settings):
        mock_settings.client_type = "feeder"
        server_conn = ServerConnection()
        server_conn.feeder_id = None
        mock_socketio.reset_mock()
    ...
    def test_connect_to_server_error(self, mock_socketio, mock_log, mock_get_socket_address, mock_settings):
    ...
    def test_cleanup(self, mock_socketio, mock_log, mock_settings):
        server_conn = ServerConnection()
    ...
    def test_on_stream_start_success(self, mock_socketio, mock_settings):
        stream_start = MagicMock()
    ...
    def test_on_stream_start_no_handler(self, mock_socketio, mock_settings):
    ...
    def test_on_stream_stop_success(self, mock_socketio, mock_settings):
        stream_stop = MagicMock()
    ...
    def test_on_stream_stop_no_handler(self, mock_socketio, mock_settings):
    ...
    def test_on_assigning_id(self, mock_socketio, mock_set_feeder_id, mock_thread, mock_settings):
    ...
    def test_reconnect(self, mock_socketio, mock_settings):
        server_conn = ServerConnection()
        mock_socketio.reset_mock()
